...
<div style="margin-top: 2rem;">
    ...
    <div class="page-header-flex" style="display: flex; align-items: center; margin-bottom: 2rem;">
        <a href="{{ route('libraries.index', ['tab' => 'clubs']) }}" class="btn btn-outline" style="margin-right: 1rem; padding: 0.5rem; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; width: 40px; height: 40px; flex-shrink: 0;">
        ...
        <div>
            <h1 style="font-size: 1.75rem; font-weight: 700; margin-bottom: 0.25rem; letter-spacing: -0.025em;">Edit <span style="color: var(--accent);">Eagle Club</span></h1>
            <p style="color: var(--text-muted); font-size: 1rem; margin: 0;">Manage the club details and dynamically assign officers to positions.</p>
        </div>
    </div>
